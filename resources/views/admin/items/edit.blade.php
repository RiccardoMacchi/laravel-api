        ...
        <form action="{{ route('admin.items.update', $item) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="repo_name" name="repo_name"
                    placeholder="Inserisci il nome della repository" value="{{ old('repo_name', $item->repo_name) }}">
                @error('repo_name')
                    <small>{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project_link" name="project_link"
                    placeholder="Inserisci il link al progetto" value="{{ old('project_link', $item->project_link) }}">
                @error('project_link')
                    <small>{{ $message }}</small>
                @enderror
            </div>
